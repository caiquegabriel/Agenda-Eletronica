  ...
  registerTables() async {
    ...
    return await openDatabase(path, version: 1,
      onConfigure: (Database db) async {
        // Tabela do telefone
        await db.execute(
          'CREATE TABLE IF NOT EXISTS telephone (id INTEGER PRIMARY KEY AUTOINCREMENT, telephone TEXT, type TEXT, contactId INTEGER)'
        );
        // Tabela do contato
        await db.execute(
      ...
      onCreate: (Database db, int a) async {
        // Tabela do telefone
        await db.execute(
          'CREATE TABLE IF NOT EXISTS telephone (id INTEGER PRIMARY KEY AUTOINCREMENT, telephone TEXT, contactId INTEGER, type TEXT)'
        );
        // Tabela do contato
        await db.execute(
          'CREATE TABLE IF NOT EXISTS contact (id INTEGER PRIMARY KEY AUTOINCREMENT, firstName TEXT, secondName TEXT, email TEXT, photo Text, cpf TEXT)'
